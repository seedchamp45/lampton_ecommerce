...
ActiveRecord::Schema.define(version: 20180611164552) do
  ...
  create_table "myaccs", force: :cascade do |t|
    t.string "iduser"
    t.string "email"
    t.string "firstname"
    t.string "lastname"
  ...
  create_table "newsandmedia", force: :cascade do |t|
    t.string "title"
    t.string "body"
    t.string "status"
    t.string "image_file_name"
  ...
  create_table "omise_payments", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "productpdfs", force: :cascade do |t|
    t.string "filename"
  ...
  create_table "spree_orders", id: :serial, force: :cascade do |t|
    ...
    t.date "invoice_date"
    t.string "spree_orders_file_name"
    t.string "spree_orders_content_type"
    t.integer "spree_orders_file_size"
    t.datetime "spree_orders_updated_at"
  ...
  create_table "udetailupdates", force: :cascade do |t|
    t.string "iduser"
    t.string "email"
    t.string "firstname"
    t.string "lastname"
  ...
  create_table "userdetailupdates", force: :cascade do |t|
    t.string "email"
    t.string "firstname"
    t.string "lastname"
    t.string "birthday"
